  ...
  return (
    <section className="panel">
      ...
      <p className="panel-intro">
        Upload one image. The indexing LangGraph analyzes it with a vision
        agent, embeds the index, and stores it in PGVector.
      </p>
      ...
      <ErrorModal
        open={showErrorModal}
        message="We could not analyze this image. Please try again with a different file."
