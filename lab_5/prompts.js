...
- currency_exchange: Convert USD prices to NIS/ILS. Pass ALL prices at once via pricesInDollar (array)—never call this tool multiple times for separate amounts. Use only for ad-hoc conversions not covered by flight_finder. Exchange rate: 1 USD ≈ 3.2 NIS.`;
...
- If you must use currency_exchange, pass every USD price in a single call using pricesInDollar—do not issue multiple currency_exchange calls.
